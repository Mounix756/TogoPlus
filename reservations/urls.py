...
urlpatterns = [
    ...
    path('backoffice/deconnexion/', views.BackofficeLogoutView.as_view(), name='backoffice_logout'),
    path('backoffice/categories/', views.BackofficeCategoryListView.as_view(), name='backoffice_categories'),
    path('backoffice/categories/ajouter/', views.BackofficeCategoryCreateView.as_view(), name='backoffice_category_create'),
    path('backoffice/categories/<int:pk>/modifier/', views.BackofficeCategoryUpdateView.as_view(), name='backoffice_category_update'),
    path('backoffice/categories/<int:pk>/supprimer/', views.BackofficeCategoryDeleteView.as_view(), name='backoffice_category_delete'),
    ...
    path('backoffice/indisponibilites/', views.BackofficeUnavailablePeriodListView.as_view(), name='backoffice_unavailable_periods'),
    path('backoffice/indisponibilites/ajouter/', views.BackofficeUnavailablePeriodCreateView.as_view(), name='backoffice_unavailable_period_create'),
    path('backoffice/indisponibilites/<int:pk>/modifier/', views.BackofficeUnavailablePeriodUpdateView.as_view(), name='backoffice_unavailable_period_update'),
    path('backoffice/indisponibilites/<int:pk>/supprimer/', views.BackofficeUnavailablePeriodDeleteView.as_view(), name='backoffice_unavailable_period_delete'),
